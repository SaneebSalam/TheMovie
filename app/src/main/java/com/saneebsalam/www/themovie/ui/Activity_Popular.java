...
public class Activity_Popular extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Call<MovieResponse_POJO> call = apiService.getPopularMovies(API_Key);
        call.enqueue(new Callback<MovieResponse_POJO>() {
            ...
            public void onResponse(@NonNull Call<MovieResponse_POJO> call, @NonNull Response<MovieResponse_POJO> response) {
                ...
                recyclerView.setLayoutManager(new GridLayoutManager(Activity_Popular.this, 2));
            ...
            public void onFailure(@NonNull Call<MovieResponse_POJO> call, @NonNull Throwable t) {
                ...
                progress.setVisibility(View.GONE);
                Toast.makeText(Activity_Popular.this, "Network Error", Toast.LENGTH_SHORT).show();
            }
        });
